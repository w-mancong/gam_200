...
namespace ALEngine::ECS
{
	...
	void Font::RenderAllText(Engine::Camera const& camera)
	{
		...
		for (Text& text : textCollection)
		{
			...
			font.fontShader.Set("proj", Math::Matrix4x4::Ortho(0.0f, static_cast<f32>(ALEngine::Graphics::OpenGLWindow::width), 0.0f, static_cast<f32>(ALEngine::Graphics::OpenGLWindow::height)));
