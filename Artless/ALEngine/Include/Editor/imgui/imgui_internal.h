...
struct IMGUI_API ImGuiTable
{
    ...
    ImRect                      Bg0ClipRectForDrawCmd;      // Actual ImDrawCmd clip rect for BG0/1 m_Channel. This tends to be == OuterWindow->ClipRect at BeginTable() because output in BG0/BG1 is cpu-clipped
    ImRect                      Bg2ClipRectForDrawCmd;      // Actual ImDrawCmd clip rect for BG2 m_Channel. This tends to be a correct, tight-fit, because output to BG2 are done by widgets relying on regular ClipRect.
